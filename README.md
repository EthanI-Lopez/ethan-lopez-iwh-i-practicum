...
**Put your HubSpot developer test account custom objects URL link here:** https://app.hubspot.com/contacts/51473060/objects/2-62510691/views/all/list
...
This project is a Node and Express application that connects to the HubSpot API using a private app token. It displays records from a custom object called Games and allows users to create new records through a form.